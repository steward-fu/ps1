...
static const struct in_default_bind in_sdl_defbinds[] = {
  ...
  { SDLK_l,         IN_BINDTYPE_PLAYER12, DKEY_CROSS },
  { SDLK_k,         IN_BINDTYPE_PLAYER12, DKEY_CIRCLE },
  { SDLK_i,         IN_BINDTYPE_PLAYER12, DKEY_SQUARE },
  { SDLK_PERIOD,    IN_BINDTYPE_PLAYER12, DKEY_START },
  { SDLK_COMMA,     IN_BINDTYPE_PLAYER12, DKEY_SELECT },
  ...
  { SDLK_BACKSPACE, IN_BINDTYPE_EMU, SACTION_ENTER_MENU },
  { SDLK_1,         IN_BINDTYPE_EMU, SACTION_SAVE_STATE },
  { SDLK_0,         IN_BINDTYPE_EMU, SACTION_LOAD_STATE },
  { SDLK_F1,        IN_BINDTYPE_EMU, SACTION_PREV_SSLOT },
  { SDLK_F2,        IN_BINDTYPE_EMU, SACTION_NEXT_SSLOT },
  { SDLK_F3,        IN_BINDTYPE_EMU, SACTION_TOGGLE_FSKIP },
  { SDLK_F4,        IN_BINDTYPE_EMU, SACTION_SCREENSHOT },
  { SDLK_F5,        IN_BINDTYPE_EMU, SACTION_TOGGLE_FPS },
  { SDLK_F6,        IN_BINDTYPE_EMU, SACTION_SWITCH_DISPMODE },
  { SDLK_F7,        IN_BINDTYPE_EMU, SACTION_TOGGLE_FULLSCREEN },
  { SDLK_F8,        IN_BINDTYPE_EMU, SACTION_FAST_FORWARD },
  { 0, 0, 0 }
};
